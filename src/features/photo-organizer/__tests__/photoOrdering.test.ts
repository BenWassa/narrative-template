...
describe("photoOrdering", () => {
  ...
  describe("video separation", () => {
    const isVideo = (photo: ProjectPhoto) =>
      photo.mimeType?.startsWith("video/") ?? false;
    ...
    it("groups by subfolder while preserving timestamp order", () => {
      const photos = [
        createPhoto({
          id: "a",
          timestamp: 1003,
          filePath: "01_DAYS/Day 01/subfolder/a.jpg",
        }),
        createPhoto({
          id: "b",
          timestamp: 1001,
          filePath: "01_DAYS/Day 01/b.jpg",
        }),
        createPhoto({
          id: "c",
          timestamp: 1002,
          filePath: "01_DAYS/Day 01/subfolder/c.jpg",
        }),
      ];
