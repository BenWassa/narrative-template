...
export const MECE_BUCKETS: MECEBucketDef[] = [
  {
    ...
    label: "Establishing",
    color: "bg-blue-500",
    description: "Wide shots, landscapes",
  },
  {
    key: "B",
    label: "People",
    color: "bg-purple-500",
    description: "Portraits, groups",
  },
  {
    key: "C",
  ...
  },
  {
    ...
    label: "Transition",
    color: "bg-yellow-500",
    description: "Travel, movement",
  },
  {
    key: "M",
    label: "Mood/Food",
    color: "bg-indigo-500",
    description: "Food, mood",
  },
  {
    key: "X",
    label: "Archive",
    color: "bg-gray-500",
    description: "Unwanted shots",
  },
];
 ...
 */
export const MECE_BUCKET_KEYS = new Set(
  MECE_BUCKETS.map((bucket) => bucket.key)
);
 ...
 */
export const BUCKET_CATEGORY_NAMES = Object.values(BUCKET_LABELS).flatMap(
  (label) =>
